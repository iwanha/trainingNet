        ...
        <div id="content">
            ...
            <div id="dSubmitPDCReceive">
                    ...
                    <ContentTemplate>
                        <table class="formTable">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="tdValue">
                                    <asp:TextBox runat="server" ID="txtCurrencyName" Visible="false" CssClass="txtMedInputStyle"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="25%" class="tdValue">
                                    <asp:TextBox runat="server" ID="txtAgrmntNo" Visible="false" CssClass="txtMedInputStyle"></asp:TextBox>
                                </td>
                                <td width="25%" class="tdDesc">
                                    <asp:Literal runat="server" ID="ltl_Customer_CustomerName" Text="Customer Name"></asp:Literal>
                                </td>
                                <td width="25%" class="tdValue">
                                    <asp:TextBox runat="server" ID="txtCustomerName" Visible="false" CssClass="txtMedInputStyle"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="25%" class="tdValue">
                                    <asp:TextBox runat="server" ID="txtInstAmt" Visible="false" CssClass="txtMedInputStyle"></asp:TextBox>
                                </td>
                                <td width="25%" class="tdDesc">
                ...
                <div id="dSubmitPDCDetail">
                    ...
                    <br />
                    <div id="dAdd" runat="server" align="right">
                        <asp:LinkButton runat="server" ID="lblAdd" Text="Add" CssClass="button" OnClick="lblAdd_Click"
