                ...
                <ContentTemplate>
                    <div runat="server" class="form" id="dGridSection" visible="false">
                        <div id="dGridAgreementPaging">
                            ...
                            <asp:GridView runat="server" ID="gvAgreementPaging" AutoGenerateColumns="false" GridLines="None" CssClass="mGrid" AlternatingRowStyle-CssClass="Alt" OnRowCommand="gvAgreementPaging_RowCommand" OnRowDataBound="gvAgreementPaging_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lbReceive" Text="Receive" CausesValidation="false" CommandName="ED"></asp:LinkButton>
