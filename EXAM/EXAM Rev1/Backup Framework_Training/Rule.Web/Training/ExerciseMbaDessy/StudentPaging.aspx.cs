...
namespace Training.ExerciseMbaDessy
{
    public partial class StudentPaging : WebFormBase
    {
        ...
        //protected global::Rule.Web.WebUserControl.Lookup.UCLookupMajor ucLookup;
        ...
        //{
        //    IRefMajorService rmSvc = (IRefMajorService)UnityFactory.Resolve<IRefMajorService>();
        //    List<RefMajor> listMajor = rmSvc.listOfRefMajor();
        //    ucCourse.BindingObject(listMajor, "MajorCode", "MajorName", true, UCReference.AdditionalSelectionType.All);
        //}
        #region PAGE
        ...
        private void initSearch()
        {
            ...
            List<RefMajor> listRefMajor = iss.listOfRefMajor();
            scParam.AddFixedSearchPropSpec(new FixedSearchPropSpec[]{
                new FixedSearchPropSpec("Student No","StudentNo"),
                new FixedSearchPropSpec("Student Name","Name"),
                new FixedSearchPropSpec("Major","RefMajorId", listRefMajor, "MajorName","RefMajorId", typeof(Int64), //  Tergantung tipedata yang mau diambil string/int64
        ...
        private void searchClick(int currentPage, bool isData = true)
        {
            ...
            pagingResult = qsOrgSvc.QueryPaging("QryStudentBaru", pagingSpec, parameter);
