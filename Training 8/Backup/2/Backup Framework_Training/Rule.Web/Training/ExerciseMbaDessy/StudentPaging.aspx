                            ...
                            <asp:GridView runat="server" ID="gvStudent" AutoGenerateColumns="false" GridLines="None" CssClass="mGrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblMajor" Text='<%# Eval("Major") %>'></asp:Label>

                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <asp:LinkButton runat="server" ID="lb_Student_AverageScore" CSS="gridHeaderTitle"
                                                CommandName="Sort" CommandArgument="AverageScore" Text="Avera geScore"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="Label1" Text='<%# Eval("Major") %>'></asp:Label>
