                        ...
                        <table class="formTable">
                            ...
                            <tr>
                                ...
                                <td width="80%" class="tdValue">
                                    ...
                                    <asp:TextBox runat="server" ID="txtStudentScoreId" Visible="false"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
                    ...
                    <ContentTemplate>
                        <asp:GridView runat="server" ID="gvScore" AutoGenerateColumns="false" GridLines="None" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>
                                        <asp:Literal runat="server" ID="ltlScore" Text="Score"></asp:Literal>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                            ...
                            <asp:GridView runat="server" ID="gvScoreTemp" AutoGenerateColumns="false" GridLines="None" CssClass="mGrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblCourseNameTemp" Text='<%# Eval("Course") %>'></asp:Label>
