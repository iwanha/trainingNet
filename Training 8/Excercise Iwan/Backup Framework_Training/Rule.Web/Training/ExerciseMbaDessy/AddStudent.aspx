                        ...
                        <table class="formTable">
                            <tr>
                                <td width="20%" class="tdDesc">
                                    ...
                                    <asp:Literal runat="server" ID="ltl_Student_StudentId" Visible="true"></asp:Literal>
                                </td>
                                <td width="80%" class="tdValue">
                                    <asp:TextBox runat="server" ID="txtStudentNo" CssClass="txtMedInputStyle"></asp:TextBox>
                                    <asp:TextBox runat="server" ID="txtStudentId" Visible="true"></asp:TextBox>
                                </td>
                            </tr>
...
<%--                            <asp:TextBox runat="server" ID="txtScore" Visible="false"></asp:TextBox>
                            <asp:TextBox runat="server" ID="txtRefCourseId" Visible="false"></asp:TextBox>--%>
                    ...
                    <ContentTemplate>
                        ...
                        <div id="Div1">
                            <asp:GridView runat="server" ID="gvScoreTemp" AutoGenerateColumns="false" GridLines="None" CssClass="mGrid"
                                AlternatingRowStyle-CssClass="Alt" OnRowCommand="gvScoreTemp_RowCommand" OnRowDataBound="gvGrid_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:Label runat="server" ID="lblRefCourseIdTemp" Text='<%# Eval("RefCourseId") %>'></asp:Label>--%>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Literal runat="server" ID="ltlStudentScoreIdTemp" Text="Student Score Id"></asp:Literal>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtStudentScoreIdTemp" ></asp:TextBox>
                                            <%--<asp:Label runat="server" ID="lblStudentScoreIdTemp" Text='<%# Eval("StudentScoreId") %>'></asp:Label>--%>
                                            <%--<asp:Label runat="server" ID="lblRefCourseIdTemp" Text='<%# Eval("RefCourseId") %>'></asp:Label>--%>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <uc5:UCReference runat="server" id="ucCourse"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <uc4:UCInputNumber runat="server" id="ucInputScore" Text='<%# Eval("Score") %>' />
            ...
            <br />
            <br />
            <asp:LinkButton runat="server" ID="lbAdd" OnClick="lbAdd_Click" Text="Add" CssClass="button" CausesValidation="true" align="center" Visible="false"></asp:LinkButton>
            <%--Align sudah center tp tombol masih dikiri?--%>
            <br />
            <br />
            <br />
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label runat="server" ID="lblGridRefCourseId" Visible="false" Text='<%# Eval("RefCourseId") %>'></asp:Label>
