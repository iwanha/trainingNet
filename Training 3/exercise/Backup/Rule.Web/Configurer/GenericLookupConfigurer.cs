...
namespace Rule.Web.Configurer
{
    public class GenericLookupConfigurer : IUnityConfigurer
    {
        ...
        public void Configure(IUnityContainer container)
        {
            ...
            string scriptFilePath = HttpContext.Current.Request.PhysicalApplicationPath
                + ConfigurationManager.AppSettings[GenericLookupData.SCRIPT_VIRTUAL_PATH].Substring(2).Replace('/','\\');
